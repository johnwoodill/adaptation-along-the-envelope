...
# Location to download full data set (108.2MB) 
# https://mega.nz/#!rBADyAJB!LXcI1A7ktAs4jiW_jCHADmDYVRL41w93TVTk5_VBNEM

cropdat <- readRDS("data/full_ag_data.rds")
cropdat <- filter(cropdat, abs(long) <= 100)
newcropdat <- cropdat[,c(1:3, 6:30, 71)]

# Balanced years
cropdat <- filter(newcropdat, year >= 1960)
...
ag_cropdat$corn_w2 <- (ag_cropdat$corn_grain_p*ag_cropdat$corn_rprice)
#ag_cropdat$cotton_w1 <- ag_cropdat$cotton_p*ag_cropdat$cotton_a
ag_cropdat$cotton_w2 <- ag_cropdat$cotton_p*ag_cropdat$cotton_rprice
#ag_cropdat$wheat_w1 <- ag_cropdat$wheat_p*ag_cropdat$wheat_a
ag_cropdat$wheat_w2 <- ag_cropdat$wheat_p*ag_cropdat$wheat_rprice
#ag_cropdat$hay_w1 <- ag_cropdat$hay_p*ag_cropdat$hay_a
ag_cropdat$hay_w2 <- ag_cropdat$hay_p*ag_cropdat$hay_rprice
#ag_cropdat$soybean_w1 <- ag_cropdat$soybean_p*ag_cropdat$soybean_a
ag_cropdat$soybean_w2 <- ag_cropdat$soybean_p*ag_cropdat$soybean_rprice
