...
cropdat1960 <- filter(cropdat1960, !is.na(cropland) & !is.na(cropland))
...
cropdat2000 <- filter(cropdat2000, !is.na(cropland) & !is.na(cropland))
...
ggplot(NULL) + geom_line(aes(x = dens.cropland1960$x, y = dens.cropland1960$y, color = "1960's")) + 
