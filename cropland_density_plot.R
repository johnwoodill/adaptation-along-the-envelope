...
cropdat1960[is.na(cropdat1960)] <- 0
#cropdat1960 <- filter(cropdat1960, !is.na(corn_grain_a) & !is.na(cotton_a) & !is.na(hay_a) & !is.na(wheat_a) & !is.na(soybean_a))
...
cropdat1960 <- filter(cropdat1960, cropland != 0)
...
cropdat2000[is.na(cropdat2000)] <- 0
...
cropdat2000 <- filter(cropdat2000, cropland != 0)
