...
diffdensplot <- ggplot(NULL) + 
      ...
      annotate("segment", x=-Inf, xend=Inf, y=-Inf, yend=-Inf, color = "grey") +
      annotate("segment", x=-Inf, xend=-Inf, y=-Inf, yend=Inf, color = "grey") +
      annotate("text", x = 17, y = 57, label = "Increase activity in \n counties that warmed the most", fontface = 2) +
      annotate("text", x = 17, y = -37, label = "Increase activity in \n counties that cooled the most", fontface = 2) +
