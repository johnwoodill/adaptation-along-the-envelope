...
# , "Latitude", "Income per Capita", "Population Density",
...
names(cs.corn.mod2$coefficients) <- c("Intercept", "Degree Days (10-30C)", "Square Root Degree Days (34C)",
...
names(cc.corn.mod1$coefficients) <- c("Intercept", "Avg. Temperature", "Avg. Temperature Squared", "Precipitation",
                                 "Precipitation Squared")
# , "Latitude", "Income per Capita", "Population Density",
#                                  "Population Density Squared", "Water Capacity", "Percent Clay", "Minimum Permeability", 
#                                  "K-factor of Top Soil", "Best Soil Class")
...
names(cc.corn.mod2$coefficients) <- c("Intercept", "Degree Days (10-30C)", "Square Root Degree Days (34C)",
                                     "Precipitation", "Precipitation Squared")
# , "Latitude", "Income per Capita", "Population Density",
#                                  "Population Density Squared", "Water Capacity", "Percent Clay", "Minimum Permeability", 
#                                  "K-factor of Top Soil", "Best Soil Class")
...
star1 <- stargazer(list(cs.corn.mod1, p.corn.mod1, cc.corn.mod1, p.corn.mod3), align = FALSE, no.space = FALSE, style = "aer", digits = 4,
          ...
          add.lines = list(c("Fixed-effect", "None", "County, Year", "None", "County, Year")))
